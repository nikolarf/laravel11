        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex h-16 items-center justify-between">
                <div class="flex items-center">
                    <div class="shrink-0">
                        <img class="size-16"
                             src="https://www.rapidbrains.com/assets/img/services/rapidbrains-laravel.webp"
                             alt="Raf Company">
                    </div>
                            ...
                            <div>
                                <button type="button"
                                    ...
                                    <img class="size-8 rounded-full"
                                         src="https://avatars.githubusercontent.com/u/1989712?v=4" alt="">
                                </button>
                            </div>
                        </div>
                    </div>
        ...
        <div class="md:hidden" id="mobile-menu">
            ...
            <div class="border-t border-gray-700 pt-4 pb-3">
                <div class="flex items-center px-5">
                    <div class="shrink-0">
                        <img class="size-10 rounded-full" src="https://avatars.githubusercontent.com/u/1989712?v=4"
                             alt="">
                    </div>
                    <div class="ml-3">
                        <div class="text-base/5 font-medium text-white">Nikola Raf</div>
                        <div class="text-sm font-medium text-gray-400">raf@example.com</div>
                    </div>
                    <button type="button"
